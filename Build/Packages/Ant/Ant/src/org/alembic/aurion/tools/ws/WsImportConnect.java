 ...
 * holder.
 */
package org.alembic.aurion.tools.ws;


import org.alembic.aurion.tools.ws.wscompile.WsimportToolConnect;
 ...
 */
public class WsImportConnect {
    /**
     * CLI entry point. Use {@link Invoker} to
     * load tools.jar
     */
    public static void main(String[] args) throws Throwable {
        System.exit(InvokerConnect.invoke("org.alembic.aurion.tools.ws.wscompile.WsimportToolConnect", args));
    }
    ...
    public static int doMain(String[] args) throws Throwable {
        return new WsimportToolConnect(System.out).run(args) ? 0 : 1;
    }
}
