 ...
 */
public final class InvokerConnect {
    static int invoke(String mainClass, String[] args) throws Throwable {
        ...
        try {
            ClassLoader cl = InvokerConnect.class.getClassLoader();
    ...
    static {
        try {
            noSystemProxies = Boolean.getBoolean(InvokerConnect.class.getName()+".noSystemProxies");
        } catch(SecurityException e) {
            // ignore
        }
    }
