...
import org.alembic.aurion.nhincproxydocquery.NhincProxyDocQueryPortType;
...
public class PassthruDocQueryProxyWebServiceUnsecuredImpl implements PassthruDocQueryProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincproxydocquery";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincproxydocquery:RespondingGateway_CrossGatewayQueryRequestMessage";
