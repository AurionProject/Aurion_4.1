...
import org.alembic.aurion.entitydocquery.EntityDocQuerySecuredPortType;
...
public class EntityDocQueryProxyWebServiceSecuredImpl implements EntityDocQueryProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:entitydocquery";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:entitydocquery:RespondingGateway_CrossGatewayQuerySecuredRequestMessage";
