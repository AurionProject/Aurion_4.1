 ...
 * <bean id="nhinhiemnotify" class="org.alembic.aurion.nhinhiem.proxy.subscribe.NhinHiemNotifyNoOpImpl"/>
 ...
 * @author Jon Hoppesch
 */
public class NhinHiemNotifyProxyObjectFactory extends ComponentProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "HiemProxyConfig.xml";
    private static final String BEAN_NAME = "nhinhiemnotify";
    ...
    {
        return getBean(BEAN_NAME, NhinHiemNotifyProxy.class);
    }
