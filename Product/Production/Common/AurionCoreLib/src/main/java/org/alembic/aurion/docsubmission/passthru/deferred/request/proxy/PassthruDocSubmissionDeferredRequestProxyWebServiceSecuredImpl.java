...
import org.alembic.aurion.nhincproxyxdrsecured.async.request.ProxyXDRSecuredAsyncRequestPortType;
...
public class PassthruDocSubmissionDeferredRequestProxyWebServiceSecuredImpl implements PassthruDocSubmissionDeferredRequestProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincproxyxdrsecured:async:request";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincproxyxdrsecured:async:request:ProvideAndRegisterDocumentSet-bAsyncRequest_Request";
