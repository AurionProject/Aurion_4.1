...
import org.alembic.aurion.common.nhinccommon.SamlIssuerType;
...
public class SamlTokenExtractor {
    ...
    public static AssertionType GetAssertion(WebServiceContext context) {
        ...
        RawSamlAssertionUtil rawAssertionUtil = new RawSamlAssertionUtil(context);
        assertion.setRawAssertion(rawAssertionUtil.captureRawSAMLAssertion());
    ...
    public static AssertionType CreateAssertion(XMLStreamReader reader) {
        ...
        try {
            ...
            if (assertIn instanceof com.sun.xml.wss.saml.internal.saml20.jaxb20.AssertionType) {
                ...
                extractIssuer(assertType, assertion);
            }
    ...
    private static AssertionType initializeAssertion() {
        ...
        assertOut.setSamlIssuer(samlIssuer);
        samlIssuer.setIssuer(EMPTY_STRING);
        samlIssuer.setIssuerFormat(EMPTY_STRING);

        return assertOut;
    }

    /**
     * The Issuer element contains the issuer identification information.
