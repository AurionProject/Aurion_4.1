...
public class PassthruDocRetrieveProxyWebServiceSecuredImpl implements PassthruDocRetrieveProxy
{
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincproxydocretrievesecured";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincproxydocretrievesecured:RespondingGateway_CrossGatewayRetrieveRequest";
