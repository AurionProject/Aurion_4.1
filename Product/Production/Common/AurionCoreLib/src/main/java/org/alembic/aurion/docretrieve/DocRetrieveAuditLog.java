...
public class DocRetrieveAuditLog
{
     ...
     */
    public AcknowledgementType auditDocRetrieveRequest(ihe.iti.xds_b._2007.RetrieveDocumentSetRequestType auditMsg, AssertionType assertion, String direction, String _interface)
    {
        ...
        AcknowledgementType ack = logDocRetrieve(auditRequestMsg, direction, _interface, assertion);
...
//     * @return Audit acknowledgement
//     */
//    public AcknowledgementType auditNhinProxyDocRetrieveRequest(org.alembic.aurion.common.nhinccommonproxy.RespondingGatewayCrossGatewayRetrieveSecuredRequestType auditMsg, AssertionType assertion)
//    {
...
//    }
     ...
     * @return An acknowledgement of whether or not the message was successfully logged.
     */
    public AcknowledgementType auditResponse(RetrieveDocumentSetResponseType message, AssertionType assertion, String direction, String _interface)
    {
