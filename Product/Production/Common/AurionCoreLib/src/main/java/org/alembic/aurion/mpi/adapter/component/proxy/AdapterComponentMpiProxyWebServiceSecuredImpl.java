...
package org.alembic.aurion.mpi.adapter.component.proxy;

import org.alembic.aurion.adaptercomponentmpi.AdapterComponentMpiSecuredPortType;
...
public class AdapterComponentMpiProxyWebServiceSecuredImpl implements AdapterComponentMpiProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:adaptercomponentmpi";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:adaptercomponentmpi:FindCandidatesSecuredRequest";
