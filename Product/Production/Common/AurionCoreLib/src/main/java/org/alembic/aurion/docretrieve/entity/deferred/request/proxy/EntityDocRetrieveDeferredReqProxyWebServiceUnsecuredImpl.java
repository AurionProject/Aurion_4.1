...
import org.alembic.aurion.entitydocretrieve.EntityDocRetrieveDeferredRequestPortType;
...
public class EntityDocRetrieveDeferredReqProxyWebServiceUnsecuredImpl implements EntityDocRetrieveDeferredReqProxy {
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:entitydocretrieve:CrossGatewayRetrieveRequestMessage";
