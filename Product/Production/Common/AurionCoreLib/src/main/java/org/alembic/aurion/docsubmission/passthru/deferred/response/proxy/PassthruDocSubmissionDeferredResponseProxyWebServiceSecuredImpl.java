...
import org.alembic.aurion.nhincproxyxdrsecured.async.response.ProxyXDRSecuredAsyncResponsePortType;
...
public class PassthruDocSubmissionDeferredResponseProxyWebServiceSecuredImpl implements PassthruDocSubmissionDeferredResponseProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincproxyxdrsecured:async:response";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincproxyxdrsecured:async:response:ProvideAndRegisterDocumentSet-bAsyncResponse_Request";
