 ...
 * <bean id="hiemsubscribeadapter" class="org.alembic.aurion.hiemadapter.proxy.subscribe.HiemSubscribeAdapterNoOpImpl"/>
 ...
 * @author Jon Hoppesch
 */
public class AdapterHiemSubscribeProxyObjectFactory extends ComponentProxyObjectFactory {

    private static final String CONFIG_FILE_NAME = "HiemProxyConfig.xml";
    private static final String BEAN_NAME = "hiemsubscribeadapter";
     ...
     */
    public AdapterHiemSubscribeProxy getAdapterHiemSubscribeProxy()
    {
        return getBean(BEAN_NAME, AdapterHiemSubscribeProxy.class);
    }
