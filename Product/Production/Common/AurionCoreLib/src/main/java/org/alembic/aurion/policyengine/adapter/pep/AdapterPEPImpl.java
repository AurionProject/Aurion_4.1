...
import org.alembic.aurion.policyengine.adapter.pdp.proxy.AdapterPDPProxy;
import org.alembic.aurion.policyengine.adapter.pdp.proxy.AdapterPDPProxyObjectFactory;
...
public class AdapterPEPImpl {
    ...
    private static final String XSPA_PATIENT_OPT_IN = "urn:org:alembic:aurion:patient-opt-in";
    private static final String XSPA_ASSIGNING_AUTH = "urn:org:alembic:aurion:assigning-authority-id";
    private static final String XSPA_SERVICE_TYPE = "urn:org:alembic:aurion:service-type";
    ...
    private static final String XACML_SUBJECT_ORG = "urn:org:alembic:aurion:user-organization-name";
    ...
    private static final String XACML_HOME_COMMUNITY = "urn:org:alembic:aurion:home-community-id";
    private static final String XACML_RESOURCE_ID = "urn:oasis:names:tc:xacml:1.0:resource:resource-id";
    private static final String XACML_ASSIGING_AUTH = "urn:org:alembic:aurion:assigning-authority-id";
    private static final String XACML_DOCUMENT_ID = "urn:org:alembic:aurion:document-id";
    private static final String XACML_DOC_COMMUNITY_ID = "urn:org:alembic:aurion:home-community-id";
    private static final String XACML_DOC_REPOSITORY_ID = "urn:org:alembic:aurion:document-repository-id";
    private static final String XACML_SUBSCRIPTION_ID = "urn:org:alembic:aurion:subscription-topic";
