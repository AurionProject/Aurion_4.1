 ...
 * <bean id="connectionmanager" class="org.alembic.aurion.common.connectionmanager.proxy.ConnectionManagerNoOpImpl"/>
 ...
 * context.getBean("connectionmanager");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getConnectionManagerProxy() method in this class.
 *
 * @author Sai Valluripalli
 */
public class ConnectionManagerProxyObjectFactory extends ComponentProxyObjectFactory
{
    private static final String CONFIG_FILE_NAME = "CommonServicesProxyConfig.xml";
    private static final String BEAN_NAME_CONNECTION_MANAGER = "connectionmanager";
    ...
    /**
     * Return an instance of the NhincConnectionManagerProxy class.
     *
     * @return An instance of the NhincConnectionManagerProxy class.
     */
    public ConnectionManagerProxy getConnectionManagerProxy() {

        return getBean(BEAN_NAME_CONNECTION_MANAGER, ConnectionManagerProxy.class);
    }
}
