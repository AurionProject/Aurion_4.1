...
import org.alembic.aurion.entitypatientdiscoveryasyncreq.EntityPatientDiscoveryAsyncReqPortType;
import org.alembic.aurion.nhincentityxdr.EntityXDRPortType;
...
public class EntityDocSubmissionProxyWebServiceUnsecuredImpl implements EntityDocSubmissionProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincentityxdr";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincentityxdr:ProvideAndRegisterDocumentSet-b";
