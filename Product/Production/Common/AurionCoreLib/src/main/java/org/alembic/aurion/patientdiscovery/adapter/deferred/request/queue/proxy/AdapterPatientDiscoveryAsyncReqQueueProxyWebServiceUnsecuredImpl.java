...
import org.alembic.aurion.adapterpatientdiscoveryasyncreqqueue.AdapterPatientDiscoveryAsyncReqQueuePortType;
 ...
 */
public class AdapterPatientDiscoveryAsyncReqQueueProxyWebServiceUnsecuredImpl implements AdapterPatientDiscoveryAsyncReqQueueProxy
{
    private static Service cachedService = null;
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:adapterpatientdiscoveryasyncreqqueue";
    private static final String SERVICE_LOCAL_PART = "AdapterPatientDiscoveryAsyncReqQueue";
    private static final String PORT_LOCAL_PART = "AdapterPatientDiscoveryAsyncReqQueuePortSoap";
    private static final String WSDL_FILE = "AdapterPatientDiscoveryAsyncReqQueue.wsdl";
     ...
     * Default constructor.
     */
    public AdapterPatientDiscoveryAsyncReqQueueProxyWebServiceUnsecuredImpl()
    {
        log = createLogger();
    }
...
//    public PRPAIN201306UV02 respondingGatewayPRPAIN201305UV02(org.hl7.v3.PRPAIN201305UV02 body, AssertionType assertion)
    {
        ...
        String sServiceName = NhincConstants.PATIENT_DISCOVERY_ADAPTER_ASYNC_REQ_QUEUE_SERVICE_NAME;
        ...
        try
        {
            if (request != null)
            {
                ...
                if (NullChecker.isNotNullish(url))
                {
                    ...
                    AdapterPatientDiscoveryAsyncReqQueuePortType port = getPort(url, NhincConstants.PATIENT_DISCOVERY_ACTION, WS_ADDRESSING_ACTION, assertion);
                    response = (MCCIIN000002UV01) oProxyHelper.invokePort(port, AdapterPatientDiscoveryAsyncReqQueuePortType.class, "addPatientDiscoveryAsyncReq", wrappedRequest);
                }
                else
                {
     ...
     */
    protected AdapterPatientDiscoveryAsyncReqQueuePortType getPort(String url, String serviceAction, String wsAddressingAction, AssertionType assertion)
    {
        AdapterPatientDiscoveryAsyncReqQueuePortType port = null;
        Service service = getService();
        if (service != null)
        {
            log.debug("Obtained service - creating port.");

            port = service.getPort(new QName(NAMESPACE_URI, PORT_LOCAL_PART), AdapterPatientDiscoveryAsyncReqQueuePortType.class);
