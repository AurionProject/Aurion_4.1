...
import org.alembic.aurion.nhinccomponentpatientcorrelation.PatientCorrelationPortType;
...
public class PatientCorrelationProxyWebServiceUnsecuredImpl implements PatientCorrelationProxy {
    ...
    private static final String WS_ADDRESSING_ACTION_RETRIEVE = "urn:org:alembic:aurion:nhinccomponentpatientcorrelation:RetrievePatientCorrelationsRequestMessage";
    private static final String WS_ADDRESSING_ACTION_ADD = "urn:org:alembic:aurion:nhinccomponentpatientcorrelation:AddPatientCorrelationRequestMessage";
