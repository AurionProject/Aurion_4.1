 ...
 *  
 */
package org.alembic.aurion.callback;
...
public class SamlCallbackHandler implements CallbackHandler {
    ...
    private Element createSVSAMLAssertion20() {
        ...
        try {
            ...
            if (tokenVals.containsKey(SamlConstants.USER_NAME_PROP) &&
                ...
                throw new SAMLException("SAML: User Name Not found");
            }
    ...
    private Element createHOKSAMLAssertion20() {
        ...
        try {
            ...
            if (tokenVals.containsKey(NhincConstants.ASSERTION_ISSUER_FORMAT_PROP) &&
                    tokenVals.containsKey(NhincConstants.ASSERTION_ISSUER_PROP)) {
                String format = tokenVals.get(NhincConstants.ASSERTION_ISSUER_FORMAT_PROP).toString();
                if (VALID_NAME_LIST.contains(format.trim())) {
                    log.debug("Setting Assertion Issuer format to: " + format);
                    String issuer = tokenVals.get(NhincConstants.ASSERTION_ISSUER_PROP).toString();
	...
	/**
	 * Creates a new UUID and strips out the dashes so resulting String is 
	 * alphanumeric only.
	 * 
    ...
    private List createAuthnStatements(SAMLAssertionFactory factory) throws SAMLException, XWSSecurityException {
        ...
        if (tokenVals.containsKey(SamlConstants.SUBJECT_LOCALITY_ADDR_PROP) &&
            ...
            log.error("SAML: Subject Locality not found");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.AUTHN_CONTEXT_CLASS_PROP) &&
            ...
            throw new SAMLException("SAML: Authentication Context Class not found");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.AUTHN_INSTANT_PROP) &&
            ...
            throw new SAMLException("SAML: Authentication instant time not found");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.AUTHN_SESSION_INDEX_PROP) &&
            ...
            log.error("SAML: Authentication session index not found");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.RESOURCE_PROP) &&
            ...
            throw new SAMLException("Authentication Decision Resource not found");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.AUTHZ_DECISION_PROP) &&
            ...
            if (VALID_AUTHZ_DECISION_LIST.contains(requestedDecision)) {
                ...
                throw new SAMLException(requestedDecision + " is not recognized as valid Should be one of: " + VALID_AUTHZ_DECISION_LIST);
            }
        } else {
            log.debug("Authentication Decision not found");
        }
    ...
    private List addAssertStatements(SAMLAssertionFactory factory) throws SAMLException {
        ...
        if (nameConstruct.length() > 0) {
            ...
            throw new SAMLException("SAML: attribute statement subject-id not found");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.USER_ORG_PROP) &&
            ...
            throw new SAMLException("SAML: No information provided to fill in user organization attribute");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.USER_ORG_ID_PROP) &&
            ...
            throw new SAMLException("SAML: No information provided to fill in user organization ID attribute");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.HOME_COM_PROP) &&
            ...
            throw new SAMLException("SAML: No information provided to fill in home community ID attribute");
        }
        ...
        try {
            ...
            if (tokenVals.containsKey(SamlConstants.USER_CODE_PROP) &&
                ...
                throw new SAMLException("SAML: No information provided to fill in user role code attribute");
            }
            if (tokenVals.containsKey(SamlConstants.USER_SYST_PROP) &&
                ...
                throw new SAMLException("SAML: No information provided to fill in user role code system attribute");
            }
            if (tokenVals.containsKey(SamlConstants.USER_SYST_NAME_PROP) &&
                ...
                throw new SAMLException("SAML: No information provided to fill in user role code system name attribute");
            }
            if (tokenVals.containsKey(SamlConstants.USER_DISPLAY_PROP) &&
                ...
                throw new SAMLException("SAML: No information provided to fill in user role display attribute");
            }
        ...
        try {
            ...
            if (tokenVals.containsKey(SamlConstants.PURPOSE_CODE_PROP) &&
                ...
                throw new SAMLException("SAML: Unable to create purpose of use code");
            }
            if (tokenVals.containsKey(SamlConstants.PURPOSE_SYST_PROP) &&
                ...
                throw new SAMLException("SAML: Unable to create purpose of use coded system");
            }
            if (tokenVals.containsKey(SamlConstants.PURPOSE_SYST_NAME_PROP) &&
                ...
                throw new SAMLException("SAML: Unable to create purpose of use coded system name");
            }
            if (tokenVals.containsKey(SamlConstants.PURPOSE_DISPLAY_PROP) &&
                ...
                throw new SAMLException("SAML: Unable to create purpose of use display name");
            }
    ...
    private Evidence createEvidence() throws SAMLException, XWSSecurityException {
        ...
        if ((tokenVals.containsKey(SamlConstants.EVIDENCE_VERSION_PROP) &&
            ...
            if (VALID_ASSERTION_VERSION_LIST.contains(requestedVersion.trim())) {
                ...
                throw new SAMLException(requestedVersion + " is not recognized as valid, Should be one of: " + VALID_ASSERTION_VERSION_LIST);
            }
        } else {
            throw new SAMLException("SAML: Evidence version Not found ");
        }
        ...
        try {
            ...
            if (tokenVals.containsKey(SamlConstants.EVIDENCE_ID_PROP) &&
                ...
                throw new SAMLException("SAML: Evidence assertion id not found");
            }
            ...
            if (tokenVals.containsKey(SamlConstants.EVIDENCE_INSTANT_PROP) &&
                ...
                try {
                    ...
                    throw new SAMLException("SAML: Evidence assertion instant: " + authnInstant +
                            " is not in a valid dateTime format " + iaex.getMessage());
                } catch (DatatypeConfigurationException ex) {
                    throw new SAMLException("SAML: Evidence assertion instant: " + authnInstant +
                            " is not in a valid dateTime format " + ex.getMessage());
                }
            } else {
                throw new SAMLException("SAML: Authentication instant time not found");
            }
            ...
            if (tokenVals.containsKey(SamlConstants.EVIDENCE_ISSUER_FORMAT_PROP) &&
                ...
                if (VALID_NAME_LIST.contains(format.trim())) {
                    ...
                    throw new SAMLException(format + " is not recognized as valid, Should be one of: " + VALID_NAME_LIST);
                }
            } else {
                throw new SAMLException("SAML: Evidence issuer identity not found");
            }
            ...
            if ((tokenVals.containsKey(SamlConstants.EVIDENCE_CONDITION_NOT_BEFORE_PROP) &&
                ...
                throw new SAMLException("SAML: Evidence NotBefore condition time not found");
            }
            ...
            if ((tokenVals.containsKey(SamlConstants.EVIDENCE_CONDITION_NOT_AFTER_PROP) &&
                ...
                throw new SAMLException("SAML: Evidence NotAfter condition time not found");
            }
    ...
    private List createEvidenceStatements(
        ...
        if (tokenVals.containsKey(SamlConstants.EVIDENCE_ACCESS_CONSENT_PROP) &&
            ...
            log.error("No Access Consent found for Evidence");
        }
        ...
        if (tokenVals.containsKey(SamlConstants.EVIDENCE_INST_ACCESS_CONSENT_PROP) &&
            ...
            log.error("No Instance Access Consent found for Evidence");
        }
