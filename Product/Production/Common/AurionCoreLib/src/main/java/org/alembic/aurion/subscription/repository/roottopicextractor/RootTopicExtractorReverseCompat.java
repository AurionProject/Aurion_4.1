...
import org.alembic.aurion.subscription.repository.dialectalgorithms.concrete.ConcreteDialectRootTopicExtractor;
import org.alembic.aurion.subscription.repository.dialectalgorithms.full.FullDialectRootTopicExtractor;
import org.alembic.aurion.subscription.repository.dialectalgorithms.simple.SimpleDialectRootTopicExtractor;
import org.alembic.aurion.subscription.repository.service.*;
...
public class RootTopicExtractorReverseCompat {
    ...
    private Element buildDocumentTopicExpression() {
        String topicExpression = "<wsnt:TopicExpression xmlns:wsnt='http://docs.oasis-open.org/wsn/b-2' Dialect='http://docs.oasis-open.org/wsn/t-1/TopicExpression/Simple' xmlns:nhinc='urn:org.alembic.aurion.hiemtopic'>nhinc:document</wsnt:TopicExpression>";
    ...
    private Element buildDocumentTopic() {
        String topicExpression = "<wsnt:Topic xmlns:wsnt='http://docs.oasis-open.org/wsn/b-2' Dialect='http://docs.oasis-open.org/wsn/t-1/TopicExpression/Simple' xmlns:nhinc='urn:org.alembic.aurion.hiemtopic'>nhinc:document</wsnt:Topic>";
        Element element = null;
        try {
            element = XmlUtility.convertXmlToElement(topicExpression);
        } catch (Exception ex) {
...
//        String documentTopic = "{urn:org.alembic.aurion.hiemtopic}document";
//
