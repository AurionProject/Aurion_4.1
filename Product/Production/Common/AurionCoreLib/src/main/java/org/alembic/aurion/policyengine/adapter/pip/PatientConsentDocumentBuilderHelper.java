...
public class PatientConsentDocumentBuilderHelper {
    ...
    private static final String FILE_NAME_SIMPLE = "XDSUniqueIds";
...
//    }
    ...
    protected synchronized String getOidFromProperty(String sPropertyName) {
        ...
        try {
            ...
            tempProp = PropertyAccessor.getProperties(FILE_NAME_SIMPLE);
...
//            propsInFile.close();
            ...
            PropertyFileManager.writePropertyFile(FILE_NAME_SIMPLE, tempProp);
