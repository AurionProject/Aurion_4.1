...
import org.alembic.aurion.adaptermpi.AdapterMpiPortType;
...
public class AdapterMpiProxyWebServiceUnsecuredImpl implements AdapterMpiProxy
{
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:adaptermpi";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:adaptermpi:FindCandidatesRequest";
        ...
        try
        {
            if (request != null)
            {
                ...
                if (NullChecker.isNotNullish(url))
                {
                    ...
                    response = (PRPAIN201306UV02) oProxyHelper.invokePort(port, AdapterMpiPortType.class, "findCandidates", wsRequest);
                }
                else
                {
