...
import org.alembic.aurion.hiem.passthru.unsubscribe.PassthruHiemUnsubscribeOrchImpl;
 ...
 * @author JHOPPESC
 */
public class PassthruHiemUnsubscribeProxyJavaImpl implements PassthruHiemUnsubscribeProxy {
    ...
    public UnsubscribeResponse unsubscribe(Unsubscribe unsubscribeRequest, AssertionType assertion, NhinTargetSystemType target, ReferenceParametersElements referenceParametersElements) throws UnableToDestroySubscriptionFault, ResourceUnknownFault {
        return new PassthruHiemUnsubscribeOrchImpl().unsubscribe(unsubscribeRequest, assertion, target, referenceParametersElements);
    }
