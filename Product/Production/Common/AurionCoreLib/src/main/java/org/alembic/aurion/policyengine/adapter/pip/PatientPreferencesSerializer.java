...
public class PatientPreferencesSerializer
{
        ...
        throws AdapterPIPException
    {
        ...
        try
        {
            ...
            JAXBContext oJaxbContext = oHandler.getJAXBContext("org.alembic.aurion.common.nhinccommonadapter");
            Marshaller oMarshaller = oJaxbContext.createMarshaller();

            StringWriter swXML = new StringWriter();

            org.alembic.aurion.common.nhinccommonadapter.ObjectFactory oObjectFactory = new org.alembic.aurion.common.nhinccommonadapter.ObjectFactory();
