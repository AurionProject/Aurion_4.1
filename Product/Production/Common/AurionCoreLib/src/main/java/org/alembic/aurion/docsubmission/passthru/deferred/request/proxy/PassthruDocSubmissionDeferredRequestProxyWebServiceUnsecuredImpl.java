...
import org.alembic.aurion.nhincproxyxdr.async.request.ProxyXDRAsyncRequestPortType;
...
public class PassthruDocSubmissionDeferredRequestProxyWebServiceUnsecuredImpl implements PassthruDocSubmissionDeferredRequestProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincproxyxdr:async:request";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincproxyxdr:async:request:ProvideAndRegisterDocumentSet-bAsyncRequest_Request";
