...
import org.alembic.aurion.nhincentityxdrsecured.async.response.EntityXDRSecuredAsyncResponsePortType;
...
public class EntityDocSubmissionDeferredResponseProxyWebServiceSecuredImpl implements EntityDocSubmissionDeferredResponseProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincentityxdrsecured:async:response";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincentityxdrsecured:async:response:ProvideAndRegisterDocumentSet-bAsyncResponse_Request";
