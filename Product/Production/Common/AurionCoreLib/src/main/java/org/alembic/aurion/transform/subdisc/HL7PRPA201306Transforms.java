...
public class HL7PRPA201306Transforms {
    ...
    public static PRPAIN201306UV02 createPRPA201306(PRPAIN201306UV02MFMIMT700711UV01Subject1 subject, String receiverOID, String senderOID, PRPAIN201306UV02 orig) {
        PRPAIN201306UV02 result = new PRPAIN201306UV02();
        ...
        // Copy ack from original 201306
        for (MCCIMT000300UV01Acknowledgement ack : orig.getAcknowledgement()) {
            result.getAcknowledgement().add(ack);
        }
        ...
        if (orig != null &&
                orig.getControlActProcess() != null) {
            if (orig.getControlActProcess().getQueryAck() != null) {
                controlActProcess.setQueryAck(orig.getControlActProcess().getQueryAck());
            }
