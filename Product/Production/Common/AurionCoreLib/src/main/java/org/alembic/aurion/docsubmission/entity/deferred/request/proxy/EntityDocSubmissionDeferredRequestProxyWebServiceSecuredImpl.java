...
import org.alembic.aurion.nhincentityxdrsecured.async.request.EntityXDRSecuredAsyncRequestPortType;
...
public class EntityDocSubmissionDeferredRequestProxyWebServiceSecuredImpl implements EntityDocSubmissionDeferredRequestProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincentityxdrsecured:async:request";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincentityxdrsecured:async:request:ProvideAndRegisterDocumentSet-bAsyncRequest_Request";
