 ...
 * <bean id="adapterauditquery" class="org.alembic.aurion.adapterauditquery.proxy.AdapterAuditQueryNoOpImpl"/>
 * the bean id is "adapterauditquery" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("adapterauditquery");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getAdapterAuditQueryProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class AdapterAuditQueryProxyObjectFactory extends ComponentProxyObjectFactory {

    private static final String CONFIG_FILE_NAME = "AdapterAuditQueryProxyConfig.xml";
    private static final String BEAN_NAME = "adapterauditquery";
     ...
     */
    public AdapterAuditQueryProxy getAdapterAuditQueryProxy() {
        return getBean(BEAN_NAME, AdapterAuditQueryProxy.class);
    }
