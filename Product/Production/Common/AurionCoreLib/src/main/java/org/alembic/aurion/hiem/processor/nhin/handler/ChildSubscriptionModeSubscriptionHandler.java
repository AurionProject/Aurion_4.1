...
import org.alembic.aurion.hiem.dte.ConsumerReferenceHelper;
import org.alembic.aurion.hiem.dte.marshallers.EndpointReferenceMarshaller;
import org.alembic.aurion.hiem.dte.marshallers.SubscribeMarshaller;
...
class ChildSubscriptionModeSubscriptionHandler extends BaseSubscriptionHandler {
    ...
    public SubscribeResponse handleSubscribe(Element subscribe) throws SubscribeCreationFailedFault {
        ...
        try {
            ...
            subscribeResponseFromAdapter = adapterProxy.subscribe(childSubscribe, assertion);
            SubscribeResponseMarshaller subscribeResponseMarshaller = new SubscribeResponseMarshaller();
            subscribeResponseElementFromAdapter = subscribeResponseMarshaller.marshal(subscribeResponseFromAdapter);
