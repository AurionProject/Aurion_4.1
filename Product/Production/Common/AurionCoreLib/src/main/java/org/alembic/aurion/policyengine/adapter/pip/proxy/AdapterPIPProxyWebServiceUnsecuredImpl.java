...
import org.alembic.aurion.adapterpip.AdapterPIPPortType;
...
public class AdapterPIPProxyWebServiceUnsecuredImpl implements AdapterPIPProxy
{
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:adapterpip";
    ...
    private static final String WS_ADDRESSING_ACTION_RETRIEVEPTCONSENTBYPTID = "urn:org:alembic:aurion:adapterpip:RetrievePtConsentByPtIdRequest";
    private static final String WS_ADDRESSING_ACTION_RETRIEVEPTCONSENTBYPTDOCID = "urn:org:alembic:aurion:adapterpip:RetrievePtConsentByPtDocIdRequest";
    private static final String WS_ADDRESSING_ACTION_STOREPTCONSENT = "urn:org:alembic:aurion:adapterpip:StorePtConsentRequest";
