...
import org.alembic.aurion.adapterpep.AdapterPEPPortType;
...
public class AdapterPEPProxyWebServiceUnsecuredImpl implements AdapterPEPProxy
{
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:adapterpep";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:adapterpep:CheckPolicyRequest";
