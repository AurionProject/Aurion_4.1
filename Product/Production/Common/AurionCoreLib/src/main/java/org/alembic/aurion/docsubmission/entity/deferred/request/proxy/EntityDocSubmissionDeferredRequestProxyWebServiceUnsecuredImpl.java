...
import org.alembic.aurion.nhincentityxdr.async.request.EntityXDRAsyncRequestPortType;
...
public class EntityDocSubmissionDeferredRequestProxyWebServiceUnsecuredImpl implements EntityDocSubmissionDeferredRequestProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincentityxdr:async:request";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincentityxdr:async:request:ProvideAndRegisterDocumentSet-bAsyncRequest_RequestMessage";
