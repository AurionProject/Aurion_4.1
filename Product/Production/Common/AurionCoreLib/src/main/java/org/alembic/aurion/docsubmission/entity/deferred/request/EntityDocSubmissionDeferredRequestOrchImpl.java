...
import org.alembic.aurion.docsubmission.passthru.deferred.request.proxy.PassthruDocSubmissionDeferredRequestProxy;
import org.alembic.aurion.docsubmission.passthru.deferred.request.proxy.PassthruDocSubmissionDeferredRequestProxyObjectFactory;
import org.alembic.aurion.lift.file.manager.LiFTFileManager;
...
public class EntityDocSubmissionDeferredRequestOrchImpl {
        ...
        if (provideAndRegisterRequestRequest != null &&
            ...
            if (checkPolicy(provideAndRegisterRequestRequest, assertion)) {
                ...
                if (errorOccurred == false) {
                    org.alembic.aurion.common.nhinccommonproxy.RespondingGatewayProvideAndRegisterDocumentSetSecuredRequestType proxyRequest = new org.alembic.aurion.common.nhinccommonproxy.RespondingGatewayProvideAndRegisterDocumentSetSecuredRequestType();
    ...
    protected XDRAcknowledgementType callNhinXDRRequestProxy(org.alembic.aurion.common.nhinccommonproxy.RespondingGatewayProvideAndRegisterDocumentSetSecuredRequestType provideAndRegisterRequestRequest, AssertionType assertion)
    {
