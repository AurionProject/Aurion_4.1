...
public class PassthruDocSubmissionProxyWebServiceUnsecuredImpl implements PassthruDocSubmissionProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincproxyxdr";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincproxyxdr:ProvideAndRegisterDocumentSet-b";
