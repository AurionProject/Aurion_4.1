...
import org.alembic.aurion.entitydocretrieve.EntityDocRetrieveDeferredResponsePortType;
...
public class EntityDocRetrieveDeferredRespProxyWebServiceUnsecuredImpl implements EntityDocRetrieveDeferredRespProxy {
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:entitydocretrieve:CrossGatewayRetrieveResponseMessage";
