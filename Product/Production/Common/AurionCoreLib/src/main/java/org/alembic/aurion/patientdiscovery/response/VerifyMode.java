...
import org.alembic.aurion.mpi.adapter.proxy.AdapterMpiProxy;
import org.alembic.aurion.mpi.adapter.proxy.AdapterMpiProxyObjectFactory;
...
public class VerifyMode implements ResponseMode {
    ...
    public PRPAIN201306UV02 processResponse(ResponseParams params) {
        ...
        for (PRPAIN201306UV02MFMIMT700711UV01Subject1 subject : response.getControlActProcess().getSubject()) {
            ...
            II patId = patientExistsLocally(requestMsg, assertion, tempResp);
            ...
            if (patId != null &&
                ...
                new TrustMode().processResponse(tempResp, assertion, patId);
            } else {
    ...
    public PRPAIN201306UV02 processResponse(PRPAIN201306UV02 response, AssertionType assertion) {
        ...
        PRPAIN201306UV02 result = response;
        PRPAIN201305UV02 query = convert201306to201305(response);

        for (PRPAIN201306UV02MFMIMT700711UV01Subject1 subject : response.getControlActProcess().getSubject()) {
            PRPAIN201306UV02 tempResp = HL7PRPA201306Transforms.createPRPA201306(subject, getReceiverCommunityId(response), getSenderCommunityId(response), response);

            II patId = patientExistsLocally(query, assertion, tempResp);
