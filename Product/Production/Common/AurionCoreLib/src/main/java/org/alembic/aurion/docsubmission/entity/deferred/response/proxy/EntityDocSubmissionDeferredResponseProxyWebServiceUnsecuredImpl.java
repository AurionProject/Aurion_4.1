...
import org.alembic.aurion.common.nhinccommonentity.RespondingGatewayProvideAndRegisterDocumentSetResponseRequestType;
import org.alembic.aurion.nhincentityxdr.async.response.EntityXDRAsyncResponsePortType;
...
public class EntityDocSubmissionDeferredResponseProxyWebServiceUnsecuredImpl implements EntityDocSubmissionDeferredResponseProxy {
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:nhincentityxdr:async:response";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:nhincentityxdr:async:response:ProvideAndRegisterDocumentSet-bAsyncResp_Request";
