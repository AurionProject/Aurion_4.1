...
public class AdapterDocQueryProxyWebServiceSecuredImpl implements AdapterDocQueryProxy
{
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:adapterdocquerysecured";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:adapterdocquerysecured:AdapterDocQueryRequestSecuredMessage";
