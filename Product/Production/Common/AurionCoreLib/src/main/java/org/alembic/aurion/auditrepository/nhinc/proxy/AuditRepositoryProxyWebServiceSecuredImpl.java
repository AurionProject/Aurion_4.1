...
import org.alembic.aurion.nhinccomponentauditrepository.AuditRepositoryManagerSecuredPortType;
...
public class AuditRepositoryProxyWebServiceSecuredImpl implements AuditRepositoryProxy {
    ...
    private static final String WS_ADDRESSING_ACTION_LOG = "urn:org:alembic:aurion:nhinccomponentauditrepository:LogEventSecuredRequest";
    private static final String WS_ADDRESSING_ACTION_FIND = "urn:org:alembic:aurion:nhinccomponentauditrepository:QueryAuditEventsSecuredRequest";
