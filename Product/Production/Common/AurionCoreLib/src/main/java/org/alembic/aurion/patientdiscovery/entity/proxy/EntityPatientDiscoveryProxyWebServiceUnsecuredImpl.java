...
public class EntityPatientDiscoveryProxyWebServiceUnsecuredImpl implements EntityPatientDiscoveryProxy
{
    ...
    private static final String NAMESPACE_URI = "urn:org:alembic:aurion:entitypatientdiscovery";
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:org:alembic:aurion:entitypatientdiscovery:RespondingGateway_PRPA_IN201305UV02RequestMessage";
