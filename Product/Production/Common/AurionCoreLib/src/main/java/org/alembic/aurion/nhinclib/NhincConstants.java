 ...
 */
package org.alembic.aurion.nhinclib;
...
public class NhincConstants {
    ...
    public static final String EVIDENCE_ATTRS_PROP = "attributes";
    ...
    // HIEM - proxy interface unsecured
    public static final String HIEM_SUBSCRIBE_PROXY_SERVICE_NAME = "nhincproxynotificationproducer";
    public static final String HIEM_UNSUBSCRIBE_PROXY_SERVICE_NAME = "nhincproxysubscriptionmanager";
    public static final String HIEM_NOTIFY_PROXY_SERVICE_NAME = "nhincproxynotificationconsumer";
    ...
    public static final String HIBERNATE_HIEM_REPOSITORY = "HiemSubRepHibernate.cfg.xml";
