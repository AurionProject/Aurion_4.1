...
public class XDRTransformsTest {
    ...
    public void testTransformProxyRequestToAuditMsg_XDS_null() {
        ...
        System.out.println("transformRequestToAuditMsg");
        org.alembic.aurion.common.nhinccommonproxy.RespondingGatewayProvideAndRegisterDocumentSetSecuredRequestType request = null;
        AssertionType assertion = null;
        String direction = "";
        String _interface = "";
        XDRTransforms instance = createTransformsClass_OverrideRequiredFields();
   ...
   /*
    ...
    public void testTransformEntityRequestToAuditMsg_XDS_empty() {
        ...
        System.out.println("transformRequestToAuditMsg");
        ProvideAndRegisterDocumentSetRequestType request = new ProvideAndRegisterDocumentSetRequestType();
        org.alembic.aurion.common.nhinccommonentity.RespondingGatewayProvideAndRegisterDocumentSetSecuredRequestType entityRequest = new org.alembic.aurion.common.nhinccommonentity.RespondingGatewayProvideAndRegisterDocumentSetSecuredRequestType();
