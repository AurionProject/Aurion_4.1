...
import org.alembic.aurion.common.nhinccommonadapter.BinaryDocumentPolicyCriteriaType;
import org.alembic.aurion.common.nhinccommonadapter.BinaryDocumentPolicyCriterionType;
...
public class AdapterPIPImplTest {
    ...
    public void testStoreOptInTrue() {
        ...
        try {
            ...
            org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType request = loadStoreRequestMessage(STORE_OPTIN_CONSENT_MESSAGE);
...
//        AdapterPIPImpl pipImpl = new AdapterPIPImpl();
//        try {
//            org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtIdRequestType request = loadRetrievePtRequestMessage(RETRIEVE_OPTIN_CONSENT_MESSAGE);
...
//        AdapterPIPImpl pipImpl = new AdapterPIPImpl();
//        try {
//            org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType request = loadStoreRequestMessage(STORE_OPTOUT_CONSENT_MESSAGE);
//            StorePtConsentResponseType response = pipImpl.storePtConsent(request);
//            assertNotNull("Store consent response was null", response);
//            assertEquals("Status not as expected", "SUCCESS", response.getStatus());
//        } catch (Exception ex) {
...
//        AdapterPIPImpl pipImpl = new AdapterPIPImpl();
//        try {
//            org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType request = loadStoreRequestMessage(STORE_FINE_CONSENT_MESSAGE);
//            StorePtConsentResponseType response = pipImpl.storePtConsent(request);
//            assertNotNull("Store consent response was null", response);
//            assertEquals("Status not as expected", "SUCCESS", response.getStatus());
//        } catch (Exception ex) {
...
//        AdapterPIPImpl pipImpl = new AdapterPIPImpl();
//        try {
//            org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtDocIdRequestType request = loadRetrieveDocRequestMessage(RETRIEVE_FINE_CONSENT_BY_DOC_MESSAGE);
...
//        AdapterPIPImpl pipImpl = new AdapterPIPImpl();
//        try {
//            org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType request = loadStoreRequestMessage(STORE_BINARY_CONSENT_MESSAGE);
//            StorePtConsentResponseType response = pipImpl.storePtConsent(request);
//            assertNotNull("Store consent response was null", response);
//            assertEquals("Status not as expected", "SUCCESS", response.getStatus());
//        } catch (Exception ex) {
...
//        AdapterPIPImpl pipImpl = new AdapterPIPImpl();
//        try {
//            org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtIdRequestType request = loadRetrievePtRequestMessage(RETRIEVE_BINARY_CONSENT_BY_PATIENT_MESSAGE);
//            RetrievePtConsentByPtIdResponseType response = pipImpl.retrievePtConsentByPtId(request);
//            assertNotNull("Retrieve consent response was null", response);
//            assertNotNull("Null Patient preferences was returned", response.getPatientPreferences());
//            PatientPreferencesType oPtPref = response.getPatientPreferences();
...
//        }
//    }
    public org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType loadStoreRequestMessage(String message) {
        org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType request = null;

        Object unmarshalledObject = unmarshallMessage(message);
        if (unmarshalledObject instanceof org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType) {
            request = (org.alembic.aurion.common.nhinccommonadapter.StorePtConsentRequestType) unmarshalledObject;
        } else {
    ...
    public org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtIdRequestType loadRetrievePtRequestMessage(String message) {
        org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtIdRequestType request = null;

        Object unmarshalledObject = unmarshallMessage(message);
        if (unmarshalledObject instanceof org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtIdRequestType) {
            request = (org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtIdRequestType) unmarshalledObject;
        } else {
            fail("Unmarshalled object is not a store patient consent message. Is: " + ((unmarshalledObject == null) ? "null" : unmarshalledObject.getClass().getName()));
        }
        return request;
    ...
    public org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtDocIdRequestType loadRetrieveDocRequestMessage(String message) {
        org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtDocIdRequestType request = null;

        Object unmarshalledObject = unmarshallMessage(message);
        if (unmarshalledObject instanceof org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtDocIdRequestType) {
            request = (org.alembic.aurion.common.nhinccommonadapter.RetrievePtConsentByPtDocIdRequestType) unmarshalledObject;
        } else {
            fail("Unmarshalled object is not a store patient consent message. Is: " + ((unmarshalledObject == null) ? "null" : unmarshalledObject.getClass().getName()));
        }
        return request;
    ...
    private Object unmarshallMessage(String message) {
        ...
        String contextPath = "org.alembic.aurion.common.nhinccommonadapter";
    ...
    private static final String STORE_OPTIN_CONSENT_MESSAGE =
            "<urn:StorePtConsentRequest xmlns:urn=\"urn:org:alembic:aurion:common:nhinccommonadapter\">" +
    ...
    private static final String RETRIEVE_OPTIN_CONSENT_MESSAGE =
            "<urn:RetrievePtConsentByPtIdRequest xmlns:urn=\"urn:org:alembic:aurion:common:nhinccommonadapter\">" +
            "   <urn:patientId>ADPTPIPTST54325432M</urn:patientId>" +
            "   <urn:assigningAuthority>1.1</urn:assigningAuthority>" +
            "</urn:RetrievePtConsentByPtIdRequest>";
    private static final String RETRIEVE_FINE_CONSENT_BY_DOC_MESSAGE =
            "<urn:RetrievePtConsentByPtDocIdRequest xmlns:urn=\"urn:org:alembic:aurion:common:nhinccommonadapter\">" +
