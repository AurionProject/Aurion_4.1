...
public class AdapterDocQueryWebServiceProxyTest
{
    ...
    public void testGetPortNullService()
    {
        try
        {
            ...
            String url = "url";
            AdapterDocQuerySecuredPortType port = sut.getPort(url, NhincConstants.DOC_QUERY_ACTION, "urn:org:alembic:aurion:adapterdocquerysecured:AdapterDocQueryRequestSecuredMessage", new AssertionType());
