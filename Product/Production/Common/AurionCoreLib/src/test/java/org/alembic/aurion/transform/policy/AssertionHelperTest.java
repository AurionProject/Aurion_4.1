...
import org.alembic.aurion.common.nhinccommon.SamlSignatureKeyInfoType;
import org.alembic.aurion.common.nhinccommon.SamlSignatureType;
...
public class AssertionHelperTest {
    ...
    public void AssertionSamlAuthnStatementAuthInstantFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:saml-authn-statement:auth-instant", sourceValue, STRING_DATATYPE);
    }
    ...
    private void verifyPolicySubject(RequestType policyRequest) {
        ...
        String[] ids = {"urn:org:alembic:aurion:saml-authn-statement:auth-instant",
            "urn:org:alembic:aurion:saml-authn-statement:session-index",
            "urn:org:alembic:aurion:saml-authn-statement:auth-context-class-ref",
            ...
            "urn:org:alembic:aurion:user-organization-name",
            "urn:oasis:names:tc:xacml:2.0:subject:role",
            "urn:org:alembic:aurion:user-role-code-system",
            "urn:org:alembic:aurion:user-role-code-system-name",
            "urn:org:alembic:aurion:user-role-description",
            "urn:oasis:names:tc:xspa:1.0:subject:purposeofuse",
            "urn:org:alembic:aurion:purpose-of-use-code-system",
            "urn:org:alembic:aurion:purpose-of-use-code-system-name",
            "urn:org:alembic:aurion:purpose-of-use-display-name"};
    ...
    private void verifyPolicyResource(RequestType policyRequest) {
        ...
        String[] ids = {"urn:org:alembic:aurion:saml-authz-decision-statement-decision",
            "urn:org:alembic:aurion:saml-authz-decision-statement-resource",
            "urn:org:alembic:aurion:saml-authz-decision-statement-action",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-id",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-issue-instant",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-version",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-issuer",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-not-before",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-not-on-or-after",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-access-consent",
            "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-instance-access-consent"};
    ...
    public void AssertionSamlAuthnStatementSessionIndexFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:saml-authn-statement:session-index", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthnStatementAuthContextClassRefFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:saml-authn-statement:auth-context-class-ref", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionUserInfoOrgNameFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:user-organization-name", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionUserInfoRoleCodedCodeSystemFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:user-role-code-system", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionUserInfoRoleCodedCodeSystemNameFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:user-role-code-system-name", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionUserInfoRoleCodedDisplayNameFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:user-role-description", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionPurposeOfDisclosureCodeSystemFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:purpose-of-use-code-system", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionPurposeOfDisclosureCodeSystemNameFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:purpose-of-use-code-system-name", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionPurposeOfDisclosureDisplayNameFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Subject", "urn:org:alembic:aurion:purpose-of-use-display-name", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementDecisionFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-decision", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementResourceFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-resource", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementActionFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-action", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionIdFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-id", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionIssueInstantFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-issue-instant", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionVersionFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-version", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionIssuerFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-issuer", sourceValue, STRING_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionConditionsNotBeforeFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-not-before", sourceValue, DATE_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionConditionsNotOnOrAfterFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-not-on-or-after", sourceValue, DATE_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionAccessConsentFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-access-consent", sourceValue, ANY_URI_DATATYPE);
    }
    ...
    public void AssertionSamlAuthzDecisionStatementEvidenceAssertionInstanceAccessConsentFromAssertionToXacml() {
        ...
        assertFalse(sourceValue.contentEquals(""));
        executeAssertionToXacmlSingleFieldTest(assertion, "Resource", "urn:org:alembic:aurion:saml-authz-decision-statement-evidence-assertion-instance-access-consent", sourceValue, ANY_URI_DATATYPE);
    }
