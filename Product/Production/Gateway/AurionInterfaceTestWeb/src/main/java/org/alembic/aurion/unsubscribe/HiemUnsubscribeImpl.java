 ...
 */
package org.alembic.aurion.unsubscribe;
...
import org.alembic.aurion.common.subscription.SubscriptionReferenceType;
import org.alembic.aurion.common.subscription.UnsubscribeType;
...
//            unsubscribeType.setSubscriptionReference(subscriptionReference);
    ...
    private org.oasis_open.docs.wsn.b_2.UnsubscribeResponse callInternalUnsubscribe(UnsubscribeRequestType request, ReferenceParametersElements referenceParametersElements) {
        ...
        try { // Call Web Service Operation
            ...
            org.alembic.aurion.nhincsubscription.NhincSubscriptionManagerService service = new org.alembic.aurion.nhincsubscription.NhincSubscriptionManagerService();
            org.alembic.aurion.nhincsubscription.SubscriptionManager port = service.getSubscriptionManagerPort();
