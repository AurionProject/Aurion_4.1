...
package org.alembic.aurion.universalclient.ws;
...
import org.alembic.aurion.common.docmgr.GenerateUniqueIdRequestType;
import org.alembic.aurion.common.docmgr.GenerateUniqueIdResponseType;
...
import org.alembic.aurion.entitydocquery.EntityDocQuery;
import org.alembic.aurion.entitydocquery.EntityDocQueryPortType;
 ...
 */
@WebService(serviceName = "DocViewerRequestServicesService", portName = "DocViewerRequestServicesPort", endpointInterface = "org.alembic.aurion.universalclient.ws.DocViewerRequestServicesPortType", targetNamespace = "http://ws.universalclient.nhinc.fha.hhs.gov/", wsdlLocation = "WEB-INF/wsdl/DocViewerRequestServices/DocViewerRequestServicesService.wsdl")
public class DocViewerRequestServices implements DocViewerRequestServicesPortType {
    ...
    private RegistryResponseType storeInboundDocumentToRespository(RetrieveDocumentSetResponseType document,
        ...
        try {
            ...
            slot1.setName("urn:org:alembic:aurion:xds:OrigDocumentUniqueId");
            ...
            for (JAXBElement<? extends IdentifiableType> object : objectList) {
                ...
                if (identifiableType instanceof ExtrinsicObjectType) {
                    ...
                    for (SlotType1 returnSlot : slottype.getSlot()) {
                        if ("urn:org:alembic:aurion:xds:OrigDocumentUniqueId".equals(returnSlot.getName())) {
                            doc = returnSlot.getValueList().getValue().get(0);
                        }
                        if ("urn:org:alembic:aurion:xds:OrigHomeCommunityId".equals(returnSlot.getName())) {
                            home = returnSlot.getValueList().getValue().get(0);
                        }
                        if ("urn:org:alembic:aurion:xds:OrigRepositoryUniqueId".equals(returnSlot.getName())) {
