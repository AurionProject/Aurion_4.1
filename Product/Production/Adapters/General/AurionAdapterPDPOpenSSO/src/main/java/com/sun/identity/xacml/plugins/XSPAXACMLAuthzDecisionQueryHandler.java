...
public class XSPAXACMLAuthzDecisionQueryHandler implements RequestHandler {
    ...
    public static final String HOME_COMMUNITY_ID = "urn:org:alembic:aurion:assigning-authority-id";
    public static final String SERVICE_TYPE = "urn:org:alembic:aurion:service-type";
    public static final String OPT_IN = "urn:org:alembic:aurion:patient-opt-in";
    //action attributes
