...
package org.alembic.aurion.adapter.cppgui.valueobject;
...
{
    private String consentPolicyOID;
    ...
    public String getConsentPolicyOID() {
        return consentPolicyOID;
    }

    public void setConsentPolicyOID(String consentPolicyOID) {
        this.consentPolicyOID = consentPolicyOID;
    }
