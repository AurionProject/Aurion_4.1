...
public class AdapterConstants {
     ...
     */
    public final static String XDSClinicallyUniqueHash = "urn:org:alembic:aurion:xds:clinicalUniqueHash";

    /**
     * Constant for the Dynamic Document Usage metadata element
     */
    public final static String XDSHasBeenAccessed = "urn:org:alembic:aurion:xds:hasBeenAccessed";
