 ...
 * @author mflynn02
 */
import org.alembic.aurion.adapter.busorchestration.nhinadapteserviceejb.AdapterConstants;
import org.alembic.aurion.adapter.busorchestration.nhinadapteserviceejb.ServiceHelper;
...
public class AdapterDocQuerySecuredImpl {
    ...
    public oasis.names.tc.ebxml_regrep.xsd.query._3.AdhocQueryResponse respondingGatewayCrossGatewayQuery(
        org.alembic.aurion.common.nhinccommonadapter.RespondingGatewayCrossGatewayQueryRequestType respondingGatewayCrossGatewayQueryRequest)
    {
        ...
        try
        {
                        ...
                        AdapterConstants.XDSDocumentEntryClassCode))
            {
                ...
                while (itr.hasNext())
                {
                    ...
                    org.alembic.aurion.common.nhinccommonadapter.RespondingGatewayCrossGatewayProvideAndRegisterDocumentSetRequestRequestType dynResult =
                        null;

                    //Get the document from the Assembler
                    try // Call Web Service Operation
                    {
                        org.alembic.aurion.documentassembly.DocumentAssembly service =
                            new org.alembic.aurion.documentassembly.DocumentAssembly();
                        org.alembic.aurion.documentassembly.DocumentAssemblyPortType port =
    ...
    private static ExtrinsicObjectType fndDynamicDocumentExtrinsicObject(
        org.alembic.aurion.common.nhinccommonadapter.RespondingGatewayCrossGatewayProvideAndRegisterDocumentSetRequestRequestType dynamicDocument)
    {
        List<JAXBElement<? extends IdentifiableType>> objectList =
