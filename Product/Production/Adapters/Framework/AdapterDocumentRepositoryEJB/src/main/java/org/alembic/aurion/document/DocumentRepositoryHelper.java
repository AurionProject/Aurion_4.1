...
import org.alembic.aurion.repository.model.Document;
import org.alembic.aurion.repository.model.DocumentQueryParams;
import org.alembic.aurion.repository.model.EventCode;
import org.alembic.aurion.repository.model.ExtraSlot;
import org.alembic.aurion.repository.service.DocumentService;
import org.alembic.aurion.repository.util.DocumentLoadUtil;
            ...
            for (int i = 0; i < identifiableObjectList.size(); i++)
            {
                ...
                if (tempObj instanceof oasis.names.tc.ebxml_regrep.xsd.rim._3.ExtrinsicObjectType)
                {
                    ...
                    else
                    {
                        ...
                        org.alembic.aurion.repository.model.Document doc =
                                new org.alembic.aurion.repository.model.Document();
...
//                        log.debug("document.isPersistent: " + doc.isPersistent()); //TODO need a better way to determine if the doc was actually persisted.
    ...
    private void extractEventCodes(List<oasis.names.tc.ebxml_regrep.xsd.rim._3.ClassificationType>
            classifications, org.alembic.aurion.repository.model.Document doc)
    {
