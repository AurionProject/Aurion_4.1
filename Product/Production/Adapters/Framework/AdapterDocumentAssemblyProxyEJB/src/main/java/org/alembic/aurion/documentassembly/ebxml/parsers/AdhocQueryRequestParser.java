 ...
 */
package org.alembic.aurion.documentassembly.ebxml.parsers;

import org.alembic.aurion.documentassembly.ebxml.EBXMLConstants;
...
public class AdhocQueryRequestParser extends EBXMLConstants {
    ...
    * to be parsed.
    * @see org.alembic.aurion.repository.util.DocumentLoadUtil
