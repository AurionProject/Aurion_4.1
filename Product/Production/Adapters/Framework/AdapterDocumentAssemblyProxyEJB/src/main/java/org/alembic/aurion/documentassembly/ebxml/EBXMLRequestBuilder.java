...
import org.alembic.aurion.assemblymanager.AssemblyManager;
import org.alembic.aurion.assemblymanager.dao.model.DocumentType;
import org.alembic.aurion.assemblymanager.utils.DateUtil;
import org.alembic.aurion.common.docmgr.DocumentManagerClient;
...
public class EBXMLRequestBuilder {
   ...
   public ExtrinsicObjectType createMetadata(String isoFormatPatientId, String documentId,
      ...
      slot = new SlotType1();
      valList = new ValueListType();
      slot.setName("urn:org:alembic:aurion:xds:clinicalUniqueHash");
      ...
      slot = new SlotType1();
      valList = new ValueListType();
      slot.setName("urn:org:alembic:aurion:xds:hasBeenAccessed");
