 ...
 *  
 */
package org.alembic.aurion.repository.util;
...
public class DocumentLoadUtil
{
    ...
    private static void storeDocument(Element documentElement) throws Exception
    {
        ...
        org.alembic.aurion.repository.model.Document doc = new org.alembic.aurion.repository.model.Document();
...
//        doc.setServiceStopTime(parseDate(getChildElementStringValue(documentElement, "serviceStopTime"), "yyyyMMddhhmmss"));
    ...
    private static void loadEventCodes(Element documentElement, org.alembic.aurion.repository.model.Document doc)
    {
        if (documentElement != null)
        {
