...
import org.alembic.aurion.common.nhinccommonadapter.ObjectFactory;
...
public class AdapterDocumentAssemblyTest {
   ...
   public void setUp() {
      try {
         ...
         instance =
                 ...
                 new QName("urn:org:alembic:aurion:documentassembly", "DocumentAssembly"));
   ...
   public void testDynamicAssemblyQuery() {
      ...
      try {
         JAXBContext jc = JAXBContext.newInstance("org.alembic.aurion.common.nhinccommonadapter");
