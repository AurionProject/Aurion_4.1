...
public class TopicMarshallerTest {
    ...
    {
        String xml = "" +
                " <wsnt:TopicExpression xmlns:wsnt='http://docs.oasis-open.org/wsn/b-2' Dialect='http://docs.oasis-open.org/wsn/t-1/TopicExpression/Simple' xmlns:nhinc='urn:org.alembic.aurion.hiemtopic'>nhinc:document</wsnt:TopicExpression>";
